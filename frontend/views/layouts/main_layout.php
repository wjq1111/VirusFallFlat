...
<a href="<?php echo Url::to(['site/admin']) ?>">学生小甲</a>
            ...
            <ul class="nav sub-nav">
              <li>
                <a href="<?php echo Url::to(['site/student1']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 吴继强</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['site/student2']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 吕明昊</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['site/student3']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 李世阳</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['site/student4']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 邱一帆</a>
              </li>
            </ul>
          </li>
        </ul>
